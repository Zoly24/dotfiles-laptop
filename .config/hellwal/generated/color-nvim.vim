" =============================================================================
" Hellwal - Auto-generated colorscheme for Neovim
" Generated by hellwal from template: nvim.vim.tpl
" =============================================================================
" Set colors_name and background
let g:colors_name = "hellwal"
set background=dark

" Load colors from hellwal
...
execute "hi Visual guibg=" . s:color_4
execute "hi WarningMsg guifg=" . s:color_11 . " gui=bold"
...
" LSP Highlights
" =============================================================================
execute "hi LspInlayHint guifg=" . s:color_8 . " guibg=NONE gui=italic"

" =============================================================================
" LazyVim Dashboard
" =============================================================================
execute "hi LazyLogo guifg=" . s:color_4 . " gui=bold"
execute "hi LazyButton guifg=" . s:color_1 . " guibg=" . s:color_0
execute "hi LazyButtonShortcut guifg=" . s:color_10 . " gui=bold"
execute "hi LazySpecial guifg=" . s:color_11 . " gui=bold"
execute "hi LazyUrl guifg=" . s:color_6 . " gui=underline"
execute "hi LazyHelp guifg=" . s:color_8 . " gui=italic"
execute "hi LazyPluginTitle guifg=" . s:color_5 . " gui=bold"
execute "hi LazySettingsTitle guifg=" . s:color_14 . " gui=bold"

" =============================================================================
" LazyVim Dashboard (Alpha)
" =============================================================================
execute "hi AlphaHeader guifg=" . s:color_4 . " gui=bold"
execute "hi AlphaButtons guifg=" . s:color_1 . " guibg=NONE"
execute "hi AlphaShortcut guifg=" . s:color_10 . " gui=bold"
execute "hi AlphaFooter guifg=" . s:color_8 . " gui=italic"
